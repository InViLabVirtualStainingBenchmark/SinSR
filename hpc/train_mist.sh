...
# =========================================================
# TRAINING — ER STAIN (smoke test)
# After smoke test passes: add HER2, Ki67, PR below.
# =========================================================

export STAIN="ER"
export CONFIG="$REPO_DIR/configs/virtualstaining_mist_er.yaml"
export SAVE_DIR="$VSC_DATA/projects/sinsr/outputs/checkpoints/mist_er_run"
